...
const EditModal = ({visibilty,setVisibilty, navigation, hideAdminModal, isDark}) => {
  console.log('===============');
          ...
          <View style={isDark ? styles.modalViewDark : styles.modalView}>
            ...
            <ScrollView>
              <View style={{flexDirection: 'column', alignItems: 'center'}}>
                ...
                <Text style={isDark ? styles.roleDark: styles.role}>Disable</Text>
...
export default connect(mapStateToProps, {hideAdminModal})(EditModal);
